...
var synth_params = {
	lfoRate:5,
	lfoDepth: 10,
	filterCutoffFreq:6396,
	filterQ:1,
	filterEnvAttackTime:0.47,
	filterEnvDecayTime: 0.00,
	filterEnvSustainLevel: 0.09,
	filterEnvReleaseTime: 0.51,
	ampEnvAttackTime: 1.31,
	ampEnvDecayTime: 0.39,
	ampEnvSustainLevel: 0.12,
	ampEnvReleaseTime: 2.27
};

var delay_params = {
	delayTime: 0.36,
	delayFeedbackGain: 0.54,
	delayWetDry: 0.45
}
var reverb_params = {
	reverbWetDry: 0.65
...
// delay.js에 connect 함수를 정의 해 synth의 output이
// delay node의 input으로, delay의 output이 reverb의 input으로 연결
